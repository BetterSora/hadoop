...
public class OrderTopn {
	...
	public static void main(String[] args) throws Exception {
		// 默认只加载core-default.xml core-site.xml hdfs-default.xml hdfs-site.xml
		...
		FileInputFormat.setInputPaths(job, new Path("F:\\java-proj\\ideaProj\\hadoop\\data\\order\\input"));
		FileOutputFormat.setOutputPath(job, new Path("F:\\java-proj\\ideaProj\\hadoop\\data\\order\\output"));
