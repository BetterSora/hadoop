...
public class LocalSumStormAckerTopology {
    ...
    public static class DataSourceSpout extends BaseRichSpout {
        ...
        /**
         * 对发射的Tuple进行缓存，为了失败可以进行重发
         */
        private ConcurrentHashMap<Integer, Values> map;
        ...
        public void nextTuple() {
            ++number;
            Values v = new Values(number);
            collector.emit(v, number);
        ...
        public void ack(Object msgId) {
            System.out.println("Ack involved : " + msgId);
        ...
        public void fail(Object msgId) {
            System.out.println("Fail involved : " + msgId);
            // 当消息处理失败了，重新发射，当然也可以做其他的逻辑处理
            this.collector.emit(this.map.get(msgId), msgId);
        }
    }
    ...
    public static class SumBolt extends BaseRichBolt {
        ...
        public void execute(Tuple input) {
            ...
            // 如果还有下一个Bolt则collector.emit(input, new Values(...)) 发射tuple时进行锚定
